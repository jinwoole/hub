  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-4 sm:p-6 lg:px-8" aria-label="Global">
    <div class="flex flex-1">
      <a href="/" class="-m-1.5 p-1.5">
        <span class="sr-only">Jinwoo Lee</span>
    ...
    <div class="flex gap-x-4 sm:gap-x-6 lg:gap-x-12">
      <div class="relative group">
        <button type="button" class="flex items-center gap-x-1 text-sm sm:text-base font-semibold leading-6 text-gray-900" aria-expanded="false">
          Products
        ...
        <div class="absolute left-0 sm:-left-8 top-full z-10 mt-2 sm:mt-3 w-60 sm:w-screen sm:max-w-md overflow-hidden rounded-lg sm:rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5 opacity-0 group-hover:opacity-100 transition ease-out duration-200 transform -translate-y-1 group-hover:translate-y-0">
            ...
            <a href="/products/dailynews" class="group relative flex items-center gap-x-4 sm:gap-x-6 rounded-md sm:rounded-lg p-3 sm:p-4 text-sm leading-5 sm:leading-6 hover:bg-gray-50">
              ...
              <div class="flex-auto">
                <p class="block font-semibold text-gray-900">
                  Daily News for TmaxCloud <span class="absolute inset-0"></span>
                </p>
                <p class="mt-1 text-gray-600">빠르고 정확한 뉴스레터 작성</p>
              </div>
            </a>
            <a href="#" class="group relative flex items-center gap-x-4 sm:gap-x-6 rounded-md sm:rounded-lg p-3 sm:p-4 text-sm leading-5 sm:leading-6 hover:bg-gray-50">
              <div class="flex h-10 w-10 sm:h-11 sm:w-11 flex-none items-center justify-center rounded-md sm:rounded-lg bg-gray-50 group-hover:bg-white">
                <svg class="h-5 w-5 sm:h-6 sm:w-6 text-gray-600 group-hover:text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              ...
              <div class="flex-auto">
                <p class="block font-semibold text-gray-900">
                  Product 3 <span class="absolute inset-0"></span>
                </p>
                <p class="mt-1 text-gray-600">Innovative product with cutting-edge technology.</p>
              </div>
            </a>
          </div>
        </div>
